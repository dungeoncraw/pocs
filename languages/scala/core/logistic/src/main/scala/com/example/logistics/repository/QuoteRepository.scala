...
class QuoteRepository(jdbcTemplate: JdbcTemplate):
  ...
  def save(quote: Quote): Quote =
    jdbcTemplate.update(
      ...
      quote.originLatitude.bigDecimal,
      quote.originLongitude.bigDecimal,
      quote.destinationLatitude.bigDecimal,
      quote.destinationLongitude.bigDecimal,
      quote.weightKg.bigDecimal,
      quote.lengthCm.bigDecimal,
      quote.widthCm.bigDecimal,
      quote.heightCm.bigDecimal,
      quote.straightDistanceKm.bigDecimal,
      quote.distanceKm.bigDecimal,
      quote.volumeM3.bigDecimal,
      quote.basePrice.bigDecimal,
      quote.distanceCost.bigDecimal,
      quote.weightCost.bigDecimal,
      quote.volumeCost.bigDecimal,
      quote.minimumPrice.bigDecimal,
      quote.finalPrice.bigDecimal,
      quote.currency,
      quote.createdAt,
      quote.expiresAt
    )
